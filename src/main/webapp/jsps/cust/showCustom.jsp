...
<div class="pd-20">
    <form id="webform" class="form form-horizontal">
        ...
        <div class="row cl border-tg">
            ...
            <div class="formControls col-xs-3">
                <input type="text" id="txtactualdate" name="actualdate" class="input-text " datatype="*" nullmsg="必须填写实际还款日期！" value="" onclick="laydate()" />
        ...
        <div class="row cl border-tg">
            ...
            <div class="formControls col-xs-3">
                <%--<input type="text" id="txtactualdate" readonly="readonly" name="actualdate" class="input-text Wdate" onfocus="WdatePicker()"/>--%>
                    <input type="text" id="txtactualdate" readonly="readonly" name="actualdate" class="input-text " datatype="*" nullmsg="必须填写实际还款日期！" value="" onclick="laydate()" />
            </div>
        </div>
        <%}%>
    </form>
