    ...
    function bindData() {
        oTable = $("#datalist").dataTable({
            ...
            "columns": [
                ...
                { "data": "acualmoney","sWidth": "80px" },
                { "data": null, "sClass": "text-c","sWidth": "110px","mRender": function (data) { return data.actualdate==null?"-":data.actualdate.substring(0,10);} },
                { "data": "LOGINNAME","sWidth": "150px" },
